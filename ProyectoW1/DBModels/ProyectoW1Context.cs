...
{
    public partial class ProyectoW1Context : DbContext
    {
...
//                optionsBuilder.UseSqlServer(@" Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=ProyectoW1;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
//            }
//        }
        public ProyectoW1Context(DbContextOptions<ProyectoW1Context> options) : base(options)
        {
